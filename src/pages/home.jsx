    ...
    return (
        ...
        <div className="container">
            ...
            <div class="right-column">
                ...
                <h1>News</h1>
                <h2>
                    <div ><span style={{marginTop: "0.0001px", color: "#f21a1a"}}>[11/2025] </span>New <a underline="hover" rel="noreferrer" target="_blank" href={dags_paper} >preprint!</a> on multi-agent RL.</div>
                    <div style={{marginTop: "8px"}}><span style={{color: "#f21a1a"}}>[10/2025] </span>Gave a talk at the <em>2025 London Open Endedness Summit</em> hosted by <a underline="hover" rel="noreferrer" target="_blank" href="https://www.imperial.ac.uk/adaptive-intelligent-robotics/" >AIRL</a>. Here are the <a underline="hover" rel="noreferrer" target="_blank" href="https://docs.google.com/presentation/d/1Pm9gHyRE1yei96dhMb8_nd0m868zMowXOm2CwCpifjY/edit?usp=sharing" >slides.</a></div>
                    ...
                    <div style={{marginTop: "8px"}}><span style={{color: "#f21a1a"}}>[5/2025] </span>My first <a underline="hover" rel="noreferrer" target="_blank" href="https://arxiv.org/abs/2505.20659v1" >paper</a> (on unsupervised environment design) was accepted to the Reinforcement Learning Conference 2025! </div>
                </h2>
            </div>
            </div>
            <NavButton />
